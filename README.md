...
- Automatically index 60 sample courses on startup
...
The application automatically generates 60 sample courses with diverse:
- **Categories**: Math, Science, Art, Music, Sports, Language, Technology, Literature
- **Types**: ONE_TIME, COURSE, CLUB
- **Age ranges**: 5-18 years with overlapping ranges
- **Prices**: $50-$250
- **Session dates**: Spread over the next 3 months
- **Grade ranges**: K-2, 1st-3rd, 4th-6th, 7th-9th, 10th-12th, All Grades
...
4. **DataInitializationService** - Sample data generation
